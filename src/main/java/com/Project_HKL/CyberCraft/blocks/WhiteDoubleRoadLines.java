...
public class WhiteDoubleRoadLines extends Block
{
    ...
    private static final VoxelShape SHAPE_W = Block.makeCuboidShape(0, 0, 0, 16, 13, 16);public WhiteDoubleRoadLines()
    {
